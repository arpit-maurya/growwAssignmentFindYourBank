...
export const optionsBankDataAllBanks = createContext();

let AllBanksDataDisplay = () => {
  ...
  let arrBankDetails = values.banksDetails;
  ...
  return (
    <>
      <optionsBankDataAllBanks.Provider
        value={{
          selectedCity,
          setSelectedCity,
          searchBox,
...
export default AllBanksDataDisplay;
